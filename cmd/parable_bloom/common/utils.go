...
// TODO: DEPRECATED - This file has been migrated to parable-bloom/tools/level-builder/pkg/common/utils.go
// All utility functions (difficulty system, occupancy, vine stats, circular blocking) have been moved.
