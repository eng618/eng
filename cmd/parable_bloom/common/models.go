...
// TODO: DEPRECATED - This file has been migrated to parable-bloom/tools/level-builder/pkg/common/models.go
// All model definitions, difficulty specs, and variety profiles have been moved to the new location.
