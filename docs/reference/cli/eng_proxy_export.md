...
Export proxy settings as environment variables for current shell

### Synopsis

Generates shell export/unset statements for eval: eval $(eng proxy export)

```
eng proxy export [flags]
```
