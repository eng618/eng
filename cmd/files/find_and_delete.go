...
var fileCategories = []FileTypeCategory{
    {
        Name: "Videos",
        Extensions: map[string]bool{
        ...
        Options: []string{
            "MP4 (.mp4)", "MKV (.mkv)", "AVI (.avi)", "QuickTime (.mov)",
            "Windows Media (.wmv)", "Flash (.flv)", "WebM (.webm)", "MPEG (.mpeg, .mpg)", "M4V (.m4v)",
        },
    },
    {
        Name: "Photos",
        Extensions: map[string]bool{
            ...
            ".bmp": true, ".tiff": true, ".webp": true, ".heic": true,
            ".raw": true, ".cr2": true, ".nef": true, ".arw": true,
        },
        Options: []string{
            "JPEG (.jpg, .jpeg)", "PNG (.png)", "GIF (.gif)", "Bitmap (.bmp)",
            "TIFF (.tiff)", "WebP (.webp)", "HEIC (.heic)",
            "RAW (.raw, .cr2, .nef, .arw)",
        },
    },
    {
        ...
        Options: []string{
            ...
            "PowerPoint (.ppt, .pptx)", "Text (.txt)", "Rich Text (.rtf)",
            "Markdown (.md)", "E-books (.epub, .mobi)",
        },
    },
    {
        Name: "Archives",
        ...
        Options: []string{
            "ZIP (.zip)", "RAR (.rar)", "7-Zip (.7z)", "Tarball (.tar)",
            "Gzip (.gz)", "BZip2 (.bz2)", "XZ (.xz)", "Disk Image (.iso)",
        },
    },
    {
        Name: "Code",
        ...
        Options: []string{
            ...
            "Web (.html, .css)", "Shell Scripts (.sh, .bash, .zsh)",
        },
    },
}
    ...
    Run: func(cmd *cobra.Command, args []string) {
        ...
        if matchFn == nil {
            ...
            for _, s := range selected {
                ...
                // future options can be mapped here (e.g. .mp4, .jpg)
            }
